...
import contact, o_aplikacji, o_mnie, parameters, results, EDA

# Ustawienie konfiguracji strony
st.set_page_config(page_title="Projekt Python - Predycja cech nieruchomosći", layout='wide', initial_sidebar_state='expanded', page_icon='pictures/EDA.png')
